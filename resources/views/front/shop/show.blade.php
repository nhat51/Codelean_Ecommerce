                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    ...
                                    <div class="pt active" data-imgbigurl="front/img/products/{{$ProductImage}}"><img
                                ...
                                <div class="tab-pane fade" id="tab-3" role="tabpanel">
                                    <div class="customer-review-option">
                                        ...
                                        <div class="comment-option">
                                            @foreach($product->productComment as $productCmt)
                                            <div class="co-item">
                                                <div class="avatar-pic">
                                                    <img src="front/img/user/{{ $productCmt->user->avatar ?? 'default-avatar.jpg' }}" alt="">
                                                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    @include('front.component.product-item',['product' => $relatedProduct])
                </div>
                @endforeach
            </div>
        </div>
